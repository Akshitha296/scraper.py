...
headers = ["name", "light_years_from_earth", "mass", "stellar_magnitude", "date_discovered", "hyperlink", "planet_type", "planet_radius", "orbital_radius", "orbital_period", "eccentricity"]
planet_data = []
new_planet_data = []
...
for index, data in enumerate(planet_data):
    ...
    print("Page Done {index+1}")

final_planet_data = []

for index, data in enumerate(planet_data):
    new_planet_data_element = new_planet_data[index]
    new_data_planet_element = [elem.replace("\n", "") for elem in new_planet_data_element]
    new_data_planet_element = new_planet_data_element[:7]
